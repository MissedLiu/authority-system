...
export default {
    ...
    methods: {
        ...
        async search() {
            ...
            //发送查询请求
            let res = await teamMemberApi.getTeamMemberList();
            console.log(res);
            //判断是否存在数据
            if (res.success) {
                //获取数据
        ...
        async selectOne() {
            ...
            if (this.phone.memberPhone != null) {
                let res = await teamMemberApi.getFindTeamMemberByPhone(this.phone);
                //判断是否存在数据
                if (res.success) {
                    //获取数据
                    this.tableData = res.data;
        ...
        async openPtCoachWindow() {
            ...
            if (this.member.mealId == "") {
                ...
                //获取团操教练
                let res = await teamMemberApi.getTeamCoachListByMealId({ mealId: this.member.mealId })
                console.log(res)
                //判断是否成功
                if (res.success) {
        ...
        async openPtProjectWindow() {
            ...
            if (this.member.mealId == "") {
                ...
                console.log(this.member.mealId);
                //获取私教项目
                let res = await teamMemberApi.getTeamProjectByPtId({ mealId: this.member.mealId })
                console.log(res)
                //判断是否成功
                if (res.success) {
        ...
        addPtpId(row) {
            ...
            this.ptProjectDialog.visible = false
            console.log(this.member.projectId);
        },
        ...
        async selectPtMeal(row) {
            ...
            let res = await teamMemberApi.getSelectTeamMealByMealId({mmId : row.mmId});
