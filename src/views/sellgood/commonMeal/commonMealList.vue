  ...
  <el-main>
    ...
    <el-form ref="searchForm" label-width="80px" :inline="true" size="small">
      ...
      <el-form-item>
        ...
        <el-button type="success" icon="el-icon-plus" @click="openAddwindow" v-if="hasPermission('sellgood:commonMeal:add')">新增</el-button>
      </el-form-item>
    </el-form>
    <el-table :data="tableData" border stripe style="width: 100%; margin-bottom: 20px" row-key="cmId"
      ...
      <el-table-column label="操作" width="200" align="center">
        <template slot-scope="scope">
          <el-button icon="el-icon-edit-outline" type="primary" size="small" @click="handleEdit(scope.row)"  v-if="hasPermission('sellgood:commonMeal:edit')">编辑
          </el-button>
          <el-button icon="el-icon-close" type="danger" size="small" @click="handleDelete(scope.row)" v-if="hasPermission('sellgood:commonMeal:delete')">删除
          </el-button>
        </template>
      </el-table-column>
    </el-table>
