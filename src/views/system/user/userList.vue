<template>
   ...
   <el-aside style="
        ...
        <el-form :model="searchModel" ref="searchForm" label-width="80px" :inline="true" size="small">
                ...
                <el-form-item>
                    <el-button icon="el-icon-search" type="primary" @click="searchEmpList(departmentId,empPhone, pageNo, pageSize)">查询
                    </el-button>
                    ...
                    v-if="hasPermission('sys:emp:add')"
                    >新增 
             ...
             <el-table :height="tableHeight" :data="userList" border stripe style="width: 100%; margin-bottom: 10px">
                ...
                <el-table-column align="center" width="350" label="操作">
                    <template slot-scope="scope">
                        <el-button icon="el-icon-edit" type="primary" size="mini" @click="handleEdit(scope.row)"  v-if="hasPermission('sys:emp:edit')">查看或修改
                        </el-button>
                        <el-button icon="el-icon-delete" type="danger" size="mini" @click="handleDelete(scope.row)"  v-if="hasPermission('sys:emp:delete')">删除
                        </el-button>
                       
                        <el-button icon="el-icon-setting" type="primary" size="mini" @click="assignUser(pageNo,pageSize,scope.row)"  v-if="hasPermission('sys:emp:user')" >分配账号
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
            ...
            <!-- 分配账号窗口 -->
            <system-dialog :title="assignUserDialog.title" :height="assignUserDialog.height" :width="assignUserDialog.width"
                :visible="assignUserDialog.visible" @onClose="onAssignClose" @onConfirm="onAssignConfirm">
                <div slot="content">
                    <!-- 分配账号数据列表 -->
                    <el-table ref="assignUserTable" :data="assignUserList" border stripe :height="assignHeight"
                        ...
                        <el-table-column align="center" width="300" label="操作">
                            <template slot-scope="scope">
                        <el-button icon="el-icon-edit" type="primary" size="mini" @click="UserRoleAll(scope.row)">详情
                        </el-button>
                        <el-button icon="el-icon-delete" type="danger" size="mini" @click="DeleteUserAndEmp(scope.row)">解绑
                        </el-button>
                        <el-button icon="el-icon-setting" type="primary" :disabled="disabled"  size="mini" @click="selectUserId(scope.row)">选择
                        </el-button>
                    </template>
                        </el-table-column>
                    </el-table>
                    ...
                    <el-pagination @size-change="assignSizeChange" @current-change="assignCurrentChange"
                        :current-page.sync="pageNo2" :page-sizes="[10, 20, 30, 40, 50]"
                        :page-size="pageSize2" layout="total, sizes, prev, pager, next, jumper"
                        :total="total2" background>
                    </el-pagination>
                </div>
            </system-dialog>

            <!-- 查看详情窗口 -->
            <system-dialog :title="UserAndRoleDialog.title" :height="UserAndRoleDialog.height" :width="UserAndRoleDialog.width"
                :visible="UserAndRoleDialog.visible" @onClose="onUserRoleClose" @onConfirm="onUserRoleConfirm">
                <div slot="content">
                    <!-- 账号角色信息数据列表 -->
