<template>
    <el-main>
        ...
        <el-table :data="tableData" border stripe style="width: 100%; margin-bottom: 20px" default-expand-all>
    ...
    methods: {
        ...
        let confirm = await this.$myconfirm("确定要导出吗?")
            ...
            import('@/vendor/Export2Excel').then(excel => {
                const tHeader = ['物品名称', '物品数量', '出库数量', '状态', '物品类型', '品牌', '出库时间']
                const filterVal = ['stockinName', 'storeNum', 'outNum', 'outIs', 'stockinType', 'brand', 'stockoutTime']
